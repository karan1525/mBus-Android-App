...
public class mBus_AvailableBusesActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    ArrayList<Bus> specificBuses;
    ArrayList<String> mReservationInfo;
    String mFrom;
    String mDestination;
    String mTotalPeople;
    String mDate;

    static boolean mIsGettingSpecificData = false;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras == null) {
            ...
            mReservationInfo = extras.getStringArrayList("info");
            mFrom = mReservationInfo.get(0);
            mDestination = mReservationInfo.get(1);
            mTotalPeople = mReservationInfo.get(2);
            mDate = mReservationInfo.get(3);
    ...
    public void displayBusList(ArrayList<Bus> busesToShow) {
